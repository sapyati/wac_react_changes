$(document).ready(function () {
  $(".mx-layout-left-drawer-tm").hover(
    function () {
      $('#submenu-close').collapse('hide');
      $('#submenu-close2').collapse('hide');
    }
  );
});
...
// ****************** Login Background Animation Script Goes here ****************
$(document).ready(function () {
...
$("#checkbox-45").click(function () {
  if ($(this).is(":checked")) {
    $(".btn-animation").addClass('slide-parent-left')
  }
  else {
    $(".btn-animation").removeClass('slide-parent-left')
  }
});


$(".mx-cisco-btn").click(function () {
  $(".mx-cisco-widget").toggleClass('mx-slide-r-l')
});
...
//     var top = $('#mx-stick-here').offset().top;
//     if (window_top > top) {
//         $('#mx-stickThis').addClass('stick');
//         $('#mx-stick-here').height($('#mx-stickThis').outerHeight());
//     } else {
//         $('#mx-stickThis').removeClass('stick');
//         $('#mx-stick-here').height(0);
//     }
// }
// $(function() {
